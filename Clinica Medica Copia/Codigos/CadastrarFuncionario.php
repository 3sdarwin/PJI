        ...
        if($result->num_rows > 0){
            ...
            if($tipoFunc == 1){
                ...
                if($result != 0){
                    ...
                    $sql = "INSERT INTO loguin VALUES('$id', '$nomeUsuario', '$senha');";

                    $result = $conn->query($sql);

                    if($result!= 0){
                        $sql = "INSERT INTO `secretaria`(`IdFunc`, `CTPS`, `IstFormacao`, `Conclusao`) VALUES ('$id', null, null, null);";
                        $conn->query($sql);
                ...
                if($result != 0){    
                    ...
                    if($result!= 0){
                        $sql = "INSERT INTO `medico`(`IdFunc`, `CRM`, `IstFormacao`, `Conclusao`) VALUES ('$id', null, null, null);";
                        $conn->query($sql);
